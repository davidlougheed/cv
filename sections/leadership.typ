...
#u.work_role([Member _(& Council Member, Jan–Dec 2021)_], "Mar 2017—Apr 2023", initial: true)
...
- _As council member:_ Worked with other council members to guide the direction of the organization.
...
#block(above: 0.8em)[Helped develop a web-based image annotation tool for training an underwater robot's computer vision system.]
